...
theta_2 = c(rep(7, 10), rep(1.5,10), rep(0, 80))
...
# print(theta.plot)
# setwd("C:/Users/Jyotishka/OneDrive/Documents/R/HS-approx")
# ggsave("theta_mcmc_runs-3.pdf", plot=theta.plot)
...
truth <- c(rep(0, 80), rep(1.5,10), rep(6, 10))
...
# setwd("C:/Users/Jyotishka/OneDrive/Documents/R/HS-approx")
# dev.copy2pdf(file = "hslike_profile-2.pdf")
# dev.copy2eps(file = "hslike_profile-2.eps")
...
lines(data, colMeans(hsl_fit$ThetaSave), lty = 16,main="HSLike",ylab="theta")
